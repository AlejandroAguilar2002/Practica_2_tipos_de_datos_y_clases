...
public class Mosca {
	...
	*/
	public String canta() {
	    ...
	    String vocalNueva;
	        vocalNueva = original.replace('a', this.vocal);
		vocalNueva = vocalNueva.replace('e', this.vocal);
		vocalNueva = vocalNueva.replace('i', this.vocal);
		vocalNueva = vocalNueva.replace('o', this.vocal);
		vocalNueva = vocalNueva.replace('u', this.vocal);
		return vocalNueva;
	}
}
